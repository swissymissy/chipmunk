...
func main() {
	...
	mux.HandleFunc("DELETE /api/students/myprofile/courses", middleware.AuthRequired(cfg.HandlerStudentRemoveACourse, cfg.JWT)) // let students remove a course from their course list
